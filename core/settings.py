...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'suebesh4321',         # Replace with your PostgreSQL password
        'HOST': 'postgressdb.cb8wu282k945.eu-north-1.rds.amazonaws.com',                 # Set to your PostgreSQL host, usually 'localhost'
